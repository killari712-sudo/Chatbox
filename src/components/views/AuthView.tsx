  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      <div className="max-w-md w-full text-center p-8 bg-white rounded-2xl shadow-lg">
        <h1 className="text-3xl font-bold font-headline text-gray-800 mb-2">Welcome to EcosystemAI</h1>
        <p className="text-gray-600 mb-8">Sign in to continue to your personal AI assistant.</p>
        <Button
          onClick={handleSignIn}
          className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 rounded-lg transition-transform transform hover:scale-105 h-auto"
        >
